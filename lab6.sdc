...
# SDRAM CLK
create_generated_clock -source [get_pins { MAX10_CLK1_50}] \
...
set_input_delay -max -clock clk 5.9 [get_ports DRAM_DQ*]
set_input_delay -min -clock clk 3.0 [get_ports DRAM_DQ*]
